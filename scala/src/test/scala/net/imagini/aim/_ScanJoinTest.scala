...
//
//    //Keyspace:at, table: pageviews
//    val AC = AimSchema.fromString("at_id(STRING), conversion(STRING), timestamp(TIME:LONG)")
//    val AC1 = new AimPartition(AC, 1000)
//    AC1.add(new AimSegmentQuickSort(AC, classOf[BlockStorageLZ4])
//      .appendRecord("AT1234", "view", "2014-10-10 17:59:01")
//      .appendRecord("AT5656", "buy", "2014-10-10 18:00:01")
//      .close)
//
...
//    val conversion_scan = new MergeScanner(AC1, "at_id, conversion, timestamp", "timestamp > '2014-10-10 16:00:00' ", "*")
//    val joinScan = new JoinScanner(sync_scan, pageviews_scan, conversion_scan)
//
//  }
