...
class UnionVsIntersectionScannerTest extends FlatSpec with Matchers {
  "Union and Intersection Join " should "return different sets" in {
    ...
    val pageviewsDescriptor = new DriftTableDescriptor(
      ...
      SortType.QUICK_SORT)
    val regionA1 = new DriftRegion("vdna.pageviews", pageviewsDescriptor)
    ...
    val conversionsDescriptor = new DriftTableDescriptor(
      ...
      classOf[BlockStorageMEMLZ4],
      SortType.QUICK_SORT)
    val regionB1 = new DriftRegion("vdna.conversions", conversionsDescriptor)
    ...
    unionJoin.nextLine should be("37b22cfb-a29e-42c3-a3d9-12d32850e103\twww.auto.com/mycar\t2014-10-10 11:59:01\t" + Drift.EMPTY)
    unionJoin.nextLine should be("37b22cfb-a29e-42c3-a3d9-12d32850e103\twww.travel.com/offers\t2014-10-10 12:01:02\t" + Drift.EMPTY)
    unionJoin.nextLine should be("37b22cfb-a29e-42c3-a3d9-12d32850e103\twww.travel.com/offers/holiday\t2014-10-10 12:01:03\t" + Drift.EMPTY)
    ...
    unionJoin.nextLine should be("a7b22cfb-a29e-42c3-a3d9-12d32850e103\twww.bank.com/myaccunt\t2014-10-10 13:59:01\t" + Drift.EMPTY)
    unionJoin.nextLine should be("a7b22cfb-a29e-42c3-a3d9-12d32850e103\twww.travel.com/offers\t2014-10-10 13:01:03\t" + Drift.EMPTY)
    ...
    val intersectionJoin = new IntersectionJoinScanner(
      new MergeScanner("user_uid, url, timestamp", "*", regionA1.segments),
      new MergeScanner("user_uid, url, timestamp, conversion", "*", regionB1.segments))
    intersectionJoin.nextLine should be("37b22cfb-a29e-42c3-a3d9-12d32850e103\twww.auto.com/mycar\t2014-10-10 11:59:01\t" + Drift.EMPTY)
    intersectionJoin.nextLine should be("37b22cfb-a29e-42c3-a3d9-12d32850e103\twww.travel.com/offers\t2014-10-10 12:01:02\t" + Drift.EMPTY)
    intersectionJoin.nextLine should be("37b22cfb-a29e-42c3-a3d9-12d32850e103\twww.travel.com/offers/holiday\t2014-10-10 12:01:03\t" + Drift.EMPTY)
