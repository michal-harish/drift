...
+----------------------------------+------------+----------+--------+---------+--------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 6m views (266Mb.gz)              | DRIFT3     | DRIFT2   | DRIFT1 | DRIFT0  | HBase  | SPARK   | HADOOP  | (drift or equivalent command)                                                                                                                                                |
| 1m syncs (32Mb.gz)               | (LZ4fs)    | (LZ4mem) | (mem)  | (LZ4fs) | (mem)  | (1.0.1) | (fs.gz) |                                                                                                                                                                              |
|                                  | Cluster[4] | Single   | Single | Single  |        |         |         |                                                                                                                                                                              |
+----------------------------------+------------+----------+--------+---------+--------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 1. Load Table 1 - Views          | 48s        | 41s      | 26s    | 28s     | 72.10s |         |         | time cat ~/addthis_views_2014-10-31_15.csv.gz | java -jar target/drift-loader.jar --separator '\t' --gzip --keyspace addthis --table views                                   |
+----------------------------------+------------+----------+--------+---------+--------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2. Load Table 2 - Syncs          | 10s        | 8.5s     | 8.5s   | 8.5s    | 13.56s |         |         | time cat ~/addthis_syncs_2014-10-31_15.csv.gz | java -jar target/drift-loader.jar --separator '\t' --gzip --keyspace addthis --table syncs                                   |
+----------------------------------+------------+----------+--------+---------+--------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 3. Stored Size (Mb)              | H213       | M222     | M660   | H213    | M1500  |         |         |                                                                                                                                                                              |
+----------------------------------+------------+----------+--------+---------+--------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 4. Minimum Heap                  | 64         |          |        | 32      |        |         | 0       | use addthis; stats                                                                                                                                                           |
|    Optimal Heap (Mb)             | 256        |          |        | 64      |        |         |         |                                                                                                                                                                              |
+----------------------------------+------------+----------+--------+---------+--------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 5. SCAN Syncs for a column value | 50ms       | 70ms     | 45ms   | 80ms    | 666ms  |         |         | select at_id,vdna_user_uid from addthis.syncs where vdna_user_uid= 'ce1e0d6b-6b11-428c-a9f7-c919721c669c'                                                                    |
+----------------------------------+------------+----------+--------+---------+--------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 6. SCAN Views for a url contains | 0.5s       | 0.9s     | 0.5s   | 1s      | 5.660s |         |         | select at_id,url from addthis.views where url contains 'http://www.toysrus.co.uk/Toys-R-Us/Toys/Cars-and-Trains/Cars-and-Playsets'                                           |
+----------------------------------+------------+----------+--------+---------+--------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 7. COUNT inner join              | 1.2s       | 2.6s     | 2.5s   | 2.8s    | 3.060s |         |         | count (select at_id from addthis.syncs join select at_id from addthis.views)                                                                                                 |
+----------------------------------+------------+----------+--------+---------+--------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 8. TRANSFORM inner join          | 8.2s       | 10s      | 6s     | 8.5s    |        |         |         | select vdna_user_uid from addthis.syncs join select timestamp,url from addthis.views into vdna.pageviews                                                                     |
+----------------------------------+------------+----------+--------+---------+--------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 9. EXPORT inner join to file     | 45s        | 35s      | 35s    | 35s     |        |         |         | time java -jar target/drift-client.jar --keyspace addthis "select vdna_user_uid from addthis.syncs join select timestamp,url from addthis.views" > ~/vdna-addthis-export.csv |
+----------------------------------+------------+----------+--------+---------+--------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+----------------------------------+------------+----------+--------+---------+-------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 102m views(4.2Gb)                | DRIFT3     | DRIFT2   | DRIFT1 | DRIFT0  | HBase | SPARK   | HADOOP  | (drift or equivalent command)                                                                                                                                                |
| 18m syncs (540Mb)                | (LZ4fs)    | (LZ4mem) | (mem)  | (LZ4fs) | (mem) | (1.0.1) | (fs.gz) |                                                                                                                                                                              |
| 24h window                       | Cluster[4] | Single   | Single | Single  |       |         |         |                                                                                                                                                                              |
+----------------------------------+------------+----------+--------+---------+-------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 1. Load Table 1 - Views          | 12.5m      |          |        |         |       |         |         | time cat ~/addthis_views_2014-10-31.csv.gz | java -jar target/drift-loader.jar --separator '\t' --gzip --keyspace addthis --table views                                      |
+----------------------------------+------------+----------+--------+---------+-------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                                  | [7]        |          |        |         |       |         |         |                                                                                                                                                                              |
+----------------------------------+------------+----------+--------+---------+-------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 6. SCAN Views for a url contains | 13s        |          |        |         |       |         |         | select at_id,url from addthis.views where url contains 'http://www.toysrus.co.uk/Toys-R-Us/Toys/Cars-and-Trains/Cars-and-Playsets'                                           |
|                                  | [2929]     |          |        |         |       |         |         |                                                                                                                                                                              |
+----------------------------------+------------+----------+--------+---------+-------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 7. COUNT inner join              | 23.5s      |          |        |         |       |         |         | count (select at_id from addthis.syncs join select at_id from addthis.views)                                                                                                 |
|                                  | [50723653] |          |        |         |       |         |         |                                                                                                                                                                              |
+----------------------------------+------------+----------+--------+---------+-------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 8. TRANSFORM inner join          | 240s       |          |        |         |       |         |         | select vdna_user_uid from addthis.syncs join select timestamp,url from addthis.views into vdna.pageviews                                                                     |
|                                  | [50723649] |          |        |         |       |         |         |                                                                                                                                                                              |
+----------------------------------+------------+----------+--------+---------+-------+---------+---------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
